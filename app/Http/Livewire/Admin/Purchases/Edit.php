...
class Edit extends Component
{
    ...
    public function mount($id)
    {
        ...
        foreach($this->productDescriptions as $product){
            foreach ($this->purchase->productItems as $item) {
                if ($item->product_description_id == $product->id) {
                    # code...
                }
            }
        };
    ...
    public function makePurchase()
    {
        ...
        ActivityLog::create([
            ...
            'payload' => "Updated Purchase No. " . $this->purchase->id
        ]);
