                        ...
                        <tbody class="table-group-divider">
                            @foreach ($sales as $sale)
                                <tr class="">
                                    ...
                                    <td>{{ Carbon\Carbon::parse($sale->sale_date)->format('jS F, Y') }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex flex-row justify-content-center">
                                            ...
                                            <div class="flex-col mx-2">
                                                <button
                                                    onclick="confirm('Are You Sure you want to delete this Product Sale?')||event.stopImmediatePropagation()"
                                                    wire:click="delete({{ $sale->id }})" class="btn btn-danger">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            </div>
                                        </div>
