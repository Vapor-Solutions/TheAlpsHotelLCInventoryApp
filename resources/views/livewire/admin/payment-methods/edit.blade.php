<div>
    <div class="container-fluid">
        <x-page-heading>Edit Payment Method</x-page-heading>

        <div class="card">
            <div class="card-header">
                <h5>Edit a Payment Method</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <img src="{{ $method->logo_url }}" class="img-thumbnail rounded-top" alt="{{ $method->logo_url }}" width="120px">
                    </div>
                </div>
